...
###  POSSÍVEIS PROBLEMAS E SOLUÇÕES PARA NOSSO ALGORITMO DE CPF  ###
import re   #importando para uso em expressões regulares
import sys

print()

#permitindo cpf com pontos e traços usando o método Replace:
#cpf_usuario = '167.288.938-30' \
#.replace('.', '') \
#.replace('-', '') \
#.replace(' ', '')

#permitindo cpf com pontos e traços usando expressões regulares:
#cpf_usuario = re.sub(
#    r'[^0-9]',
#    '',
#    '167.288.938-30'
...
#usando o input para receber os números do cpf:
entrada = input('CPF [167.288.938-30]: ')
cpf_usuario = re.sub(
    r'[^0-9]',
    '',
    entrada
...
## Verificando cpf com sequencia igual de valores ##
